...
## T10
1. No, as this covers only the depreciation cost, not the interest included in the implicit rental cost.
2. Simple maths, not hard to do tbh. Not entirely sure why you skipped this one because that was a dumb idea. 
You were basically right, so you should have gone with that answer! Talks about implicit rental price of capital
3. to do with the efficient market hypothesis

## T11
1. Uncertain, as something may be able t obe done to  decraese the naegative imapcts of the plants. the electricity provided by them is too useful to do away with, although that is irrelevant to the question. ALso because not sure how bad the effect is.
2. Pig farmer would pay for dump if the lake was owned by the oyster farmer. 
